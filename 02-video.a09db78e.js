...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ef(t)||0,es(n)&&(s=!!n.leading,i=(f="maxWait"in n)?eu(ef(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(el())},m}(e,t,{leading:r,maxWait:t,trailing:o})};let ed=new Q(document.querySelector("iframe")),eh="videoplayer-current-time";ed.on("timeupdate",B(function(e){let t=e.seconds;localStorage.setItem(eh,t)},1e3));let ep=localStorage.getItem(eh);ed.setCurrentTime(ep)}();//# sourceMappingURL=02-video.a09db78e.js.map

//# sourceMappingURL=02-video.a09db78e.js.map
